function [q_s, r_pearson, r_rank, y, coef_total, coef0_total, lambda_total] = ridgeCPM_vector_new(all_mats, all_vectors, all_behav, thresh, famid, v_alpha, lambda, k, seed)
